...
class TATTrainer(Trainer):
   ...
   def __init__(
        ...
        self.callback_handler = CallbackHandler(
            callbacks, self.model, None, self.optimizer, self.lr_scheduler
        )
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    # Optimizer step
                    self.optimizer.step()
                    #self.accelerator.scaler.step(optimizer)
            ...
            cur_f1 = eval_fi_loop(model,eval_dataloader)
            if cur_f1 >= best_f1:
                best_f1 = cur_f1
                self.save_model()
   ...
   def compute_f1(self, model, inputs):
        outputs = model.predict(**inputs,mode="eval")
        batch_size = len(labels)
        f1 = 0
        for bsz in range(batch_size):
            ground_truth = outputs["ground_truth"][bsz]
            prediction = outputs["prediction"][bsz]
            pred_scale = outputs["pred_scale"][bsz]
